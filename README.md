# Shyametrics | AI & Decision Support Systems

> **"A 0.81 ROC-AUC means nothing if no one acts on the output."**

Most data science portfolios show you what an algorithm can recognize. Shyametrics shows you what a business can *decide*.

This repository houses the frontend architecture of Shyametrics, but the code you'll find here is merely the vessel. The real story lies in the data intelligence it presents. I engineer systems that prioritize the **"next right action"** over simple classification, bridging the gap between raw data and measurable real-world impact.
...
Inside Shyametrics, you won't just find performance metrics; you will find the answers to complex, industry-specific questions:

- **What career move is actually right for this person—based on their real profile, not just what's trending?**
- **Can a model predict chronic disease risk across 13 conditions before symptoms become critical?**
